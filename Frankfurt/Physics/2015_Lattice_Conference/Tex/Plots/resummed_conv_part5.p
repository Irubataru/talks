...
set output "resummed_conv_part5.tex"
...
plot "Data/resummed_conv_h1.dat" using 1:3 title "$\\mathcal{O}(\\kappa^2)$" w l ls 1 lw 2.5,\
"Data/resummed_conv_h1.dat" using 1:4 title "$\\mathcal{O}(\\kappa^4)$" w l ls 2 lw 2.5,\
"Data/resummed_conv_h1.dat" using 1:5 title "$\\mathcal{O}(\\kappa^6)$" w l ls 3 lw 2.5,\
"Data/resummed_conv_h1.dat" using 1:6 title "$\\mathcal{O}(\\kappa^8)$" w l ls 4 lw 2.5
