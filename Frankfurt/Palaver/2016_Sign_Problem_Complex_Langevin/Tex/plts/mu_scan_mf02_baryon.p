...
set output "mu_scan_mf02_baryon.tex"
...
plot "data/mu_scan/baryon_48_mf02_s.dat" using 1:($2+1.6465953698167832*$1):3 title "$N = 48$" w yerrorbars ls 1,\
     "data/analytic/mu_scan/48/baryon_mf02.dat" using 1:($2+1.6465953698167832*$1)  title  "analytic" w l ls 2 lw 5
