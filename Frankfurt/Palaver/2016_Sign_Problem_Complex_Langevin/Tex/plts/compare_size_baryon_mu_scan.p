...
set output "compare_size_baryon_mu_scan.tex"
...
plot "data/mu_scan/baryon_48_mf0_n.dat" using 1:($2+2*$1):3 title "$N = 48$" w yerrorbars ls 1,\
     "data/mu_scan/baryon_96_mf0.dat" using 1:($2+2*$1):3  title  "$N = 96$" w yerrorbars ls 2
