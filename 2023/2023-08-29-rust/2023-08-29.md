...
> I am not an expert, I started learning this language for advent of code 2022, and only started using it for work this summer. This is my attempt at an introduction to the language, its quirks and features.
