...
set output "mu_scan_mf0_baryon_pq.tex"
...
plot "data/mu_scan/baryon_48_mf0_s.dat" using 1:($2+2*$1):3 title "$N = 48$" w yerrorbars ls 1,\
     "data/analytic/mu_scan/48/baryon_mf0.dat" using 1:($2+2*$1)  title  "analytic" w l ls 2 lw 5,\
     "data/phase_quenched/mu_scan/baryon_mf0.dat" using 1:($2+2*$1)  title  "phase quenched" w l ls 3 lw 5
