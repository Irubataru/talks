...
set output "nucleon_compare_part1.tex"
...
set style line 9 lt 1 pt 6 lc rgb "#2C3E50"
...
set label "Simulations" at 0.012,2.9 textcolor ls 10

plot "Data/Nf2/k6.txt" using 1:2:3 title "$\\mathcal{O}(\\kappa^6)$" w yerrorbars ls 9 lw 2
