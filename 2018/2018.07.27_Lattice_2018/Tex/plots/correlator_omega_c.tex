...
\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[xmin=0,xmax=24]
      ...
      ] {data/Gen2l_48x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      \addplot[
        ...
        y expr=\thisrowno{1},
        y error expr=\thisrowno{2},
      ] {data/Gen2l_40x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      ] {data/Gen2l_36x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      ] {data/Gen2l_32x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      ] {data/Gen2l_28x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      ] {data/Gen2l_24x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      ] {data/Gen2l_20x32.quadruplet.1fl.ccc_two_ascii.dat};
      ...
      ] {data/Gen2l_16x32.quadruplet.1fl.ccc_two_ascii.dat};
  ...
  \node[anchor=south west, rotate=90] at (-0.1,-0.5) {$\Omega_c^{-}$};
\end{tikzpicture}%
\end{document} 
