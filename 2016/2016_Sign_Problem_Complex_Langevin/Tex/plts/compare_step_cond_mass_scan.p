...
set output "compare_step_cond_mass_scan.tex"
...
plot "data/mass_scan/cond_48_mu1_n.dat" using 1:($2+2*1):3 title "$\\Delta t = 10^{-4}$" w yerrorbars ls 1,\
     "data/mass_scan/cond_48_mu1_s.dat" using 1:($2+2*1):3 title "$\\Delta t = 10^{-5}$" w yerrorbars ls 2
