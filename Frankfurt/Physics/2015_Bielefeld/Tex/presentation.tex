...
\author{Jonas R. Glesaaen\texorpdfstring{\\[2pt]\small Mathias Neuman, Owe Philipsen}{}}
...
\begin{frame}
  ...
  {\centering
    \includepdf[pages=1, clip, trim=0 9.85cm 0 3cm, scale=0.9]{Figs/luscher_weisz_triviality.pdf}
    \par}
