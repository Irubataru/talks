...
set output "mass_scan_mu1_cond_pq.tex"
...
plot "data/mass_scan/cond_48_mu1_s.dat" using 1:2:3 title "$N = 48$" w yerrorbars ls 1,\
     "data/analytic/mass_scan/48/cond_mu1.dat" using 1:2 title "analytic" w l ls 2 lw 5,\
     "data/phase_quenched/mass_scan/cond_mu1.dat" using 1:2  title  "phase quenched" w l ls 3 lw 5
