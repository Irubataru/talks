...
set output "mu_scan_mf0_cond_pq.tex"
...
plot "data/mu_scan/cond_48_mf0_s.dat" using 1:2:3 title "$N = 48$" w yerrorbars ls 1,\
     "data/analytic/mu_scan/48/cond_mf0.dat" using 1:2 title "analytic" w l ls 2 lw 5,\
     "data/phase_quenched/mu_scan/cond_mf0.dat" using 1:2  title  "phase quenched" w l ls 3 lw 5
